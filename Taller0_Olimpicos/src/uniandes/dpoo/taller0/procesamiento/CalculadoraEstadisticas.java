...
public class CalculadoraEstadisticas
{
	...
	public String PaisAtleta1 (String Nombre_del_Atleta)
	{/*
		...
		return("a"); */
	Atleta Info_Atleta= buscarAtleta (Nombre_del_Atleta);
	Pais Pais_Atleta= Info_Atleta.darPais();
	String Info= Pais_Atleta.darNombre();
	return (Info); 
	}
	/**
	...
	/**
	 * Busca el atleta y retorna el país
	 * @param nombreAtleta
	 * @return
	 */
	private Atleta PaisAtleta (String nombre)
	{
		InfoAtleta= buscarAtleta(nombre);
